...
export const metadata: Metadata = {
  title: "Projedar · Go-to-Market Stratejisi",
  description: "Yatırımcı sunumu eki: ağın kuruluş ve büyüme planı.",
};
...
/* 12 slayt: kapak, ilke, coğrafya, segment, kanal-müteahhit, kanal-emlakçı,
   onboarding, flywheel, fiyatlama, regülasyon, KPI, yol haritası. */
export default function GtmSunum() {
  const slides = [
    /* 1 · Kapak */
    <GorselSlayt
      key="kapak"
    ...
    >
      ...
      <p className="da da-5 mono mt-9 text-[13px] font-semibold tracking-wide text-[#2fd3bc]">
        projedar.com · pitch: projedar.com/sunum/pitch
      </p>
    </GorselSlayt>,
  ];

  return <DeckShell baslik="Go-to-market" slides={slides} />;
}
