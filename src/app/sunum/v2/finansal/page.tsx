...
/* v2 · 11 slayt: kapak, gelir mimarisi, global pazar, 24 aylık plan, kazanım, pazar payı,
...
export default function FinansalV2() {
  const slides = [
    ...
    /* 2 · Gelir mimarisi */
    <Slayt key="mimari" genis kicker="Gelir mimarisi" baslik="Üç gelir akışı, tek ağ" alt="Projedar komisyondan pay almaz. Gelir yazılım/erişim aboneliğinden; hem müteahhit hem emlakçı hem de ofis/franchise tarafından. Veri ürünleri sonraki faz.">
      <div className="grid gap-3 sm:grid-cols-3">
        <MaddeKart Ikon={Building2} baslik="1 · Müteahhit anlaşması (erken ana gelir)" metin="İlk müteahhitler kurucu programıyla ücretsiz. Sonrası aktif daire adedine göre yıllık: küçük proje (50 daireden az) 40-85 bin ₺ → 150 bin ₺ orta → 600 bin ₺+ büyük. Uzun ömürlü müşteri, düşük ayrılma." sinyal="#2fd3bc" />
        <MaddeKart Ikon={Users} baslik="2 · Emlakçı üyeliği (Yıl 2)" metin="Kurucu danışman ücretsiz; sonra yıllık ~9.000 ₺ (ayda 750 ₺). Sektördeki mevcut yazılımların altında → benimseme kolay." sinyal="#2fd3bc" />
        <MaddeKart Ikon={Layers} baslik="3 · Ofis / franchise (Yıl 2)" metin="Danışman sayısına göre kademeli ofis aboneliği ~25-95 bin ₺/yıl. Binlerce kurumsal franchise ofis var. Veri ürünleri sonraki faz." sinyal="#2fd3bc" />
      </div>
    </Slayt>,

    /* 3 · Global pazar & kategori (istatistik) */
    ...
    <Slayt key="pazar-payi" genis kicker="Pazar payı" baslik="Hedef: 2 yılda ~%5 proje, ~%10 danışman" alt="İki taraftan da (müteahhit + emlakçı) + ofisten gelir üreten yapı. Hedef pazarın küçük bir kesiti: talep yaratmıyoruz, mevcut hacmin bir dilimine erişiyoruz.">
      <div className="grid gap-3 sm:grid-cols-3">
        <MaddeKart Ikon={Building2} baslik="Projelerin ~%5'i sistemde" metin="Aktif kurumsal proje evreni ~2.000 (1.000-2.500 aktif geliştirici; 540.786 ilk-el konut/TÜİK 2025). 24 ayda ~100 proje ≈ ~%5." sinyal="#2fd3bc" />
        ...
        <MaddeKart Ikon={Layers} baslik="Ofis / franchise" metin="88.572 yetki belgeli emlak işletmesi; binlerce kurumsal franchise. ~150 ofis aboneliği = küçük bir dilim." />
      </div>
      <p className="deck-kart deck-soft mt-4 px-5 py-4 text-[13.5px] leading-relaxed">
        Pazar büyüklüğü: ~2,7 trilyon ₺ yıllık ilk-el konut cirosu. Hedef penetrasyon mütevazı ve ulaşılabilir; asıl kısıt talep değil, saha/kurulum kapasitesi.
      </p>
    </Slayt>,
    ...
    <Slayt key="birim" genis kicker="Birim ekonomisi" baslik="Tek anlaşma, edinme maliyetini hızla karşılar" alt="Yıllık peşin sözleşme + düşük müşteri kaybı + referans yoluyla düşük edinme maliyeti = sağlıklı geri ödeme.">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <MaddeKart Ikon={TrendingUp} baslik="Bir müşteriden 3 yıllık toplam gelir" metin="Düşük ayrılma × yıllık yenileme: bir müteahhitten 3 yılda 750 bin ₺+ gelir." />
    ...
    /* 8 · Gider & ekip */
    <Slayt key="gider" genis kicker="Gider & ekip" baslik="Yalın başlangıç, ölçekle büyüyen kadro" alt="Ürün canlı ve dış kaynaksız kuruldu; sabit maliyet düşük. Yatırım öncelikle saha ve kurulum kadrosuna.">
      <div className="grid gap-3 sm:grid-cols-3">
        <MaddeKart Ikon={Wallet} baslik="Ay 1-6 · yalın" metin="Kurucu + altyapı (sunucu/araç). Düşük gider; ürün zaten yayında, ana iş ilk anlaşmalar ve ağ kurulumu." sinyal="#2fd3bc" />
        <MaddeKart Ikon={Users} baslik="Ay 7-12 · kurucu dönem" metin="Saha + kurulum ekibi (kurucu müteahhit/danışman kazanımı, stok girişi). Gider ölçülü artar; gelir henüz düşük, ağ likiditesi kurulur." />
        <MaddeKart Ikon={Flame} baslik="Ay 13-24 · ölçek" metin="Küçük ekip (ürün, pazarlama, destek) + 2. şehir. Gider gelirle dengelenir, büyüme hızlanır." />
      </div>
      <p className="deck-faint mono mt-4 text-[10.5px] uppercase tracking-wider">
        Aylık gider ve kadro büyüklüğü yatırım turuna göre netleşir; kurulu ürün nedeniyle sermaye ürüne değil büyümeye gider.
      </p>
    </Slayt>,
    ...
    <Slayt key="senaryo" genis kicker="Senaryolar" baslik="Üç patika, aynı model" alt="Baz senaryo referans-satış hızına dayanır; alt ve üst bantlar kazanım hızının çarpanıdır.">
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <MaddeKart Ikon={TrendingUp} baslik="Agresif" metin="Ay 24 ~150 proje · ~8.000 ödeyen danışman · ~250 ofis, yıllık gelir hızı ~60M ₺+. Erken 2. şehir + güçlü referans döngüsü." />
      </div>
    </Slayt>,
    ...
    <Slayt key="yatirim" kicker="Yatırım" baslik="10 milyon ₺ / %25 — başlangıç değeri, ilk gelirle yükselir" alt="Ürün canlı ve dış kaynaksız kuruldu; değerin büyük kısmı zaten yaratıldı. 40M ₺'lik yatırım-sonrası değer, cirosuz aşamanın fiyatıdır; ilk ödeyen müteahhitle yükselir.">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <MaddeKart Ikon={Banknote} baslik="Pazarlama & nakit tamponu" metin="Marka, sektör etkinlikleri, nakit tamponu. Gelir ilk aydan başladığı için sermaye 24 ay idare parası değil, büyüme yakıtıdır." />
      </div>
      <p className="deck-faint mono mt-4 text-[10.5px] uppercase tracking-wider">
