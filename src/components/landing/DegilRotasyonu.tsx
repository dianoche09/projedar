...
export function DegilRotasyonu() {
  ...
  return (
    <span className="relative inline-block whitespace-nowrap align-baseline">
      ...
      {/* üstü çizme: soldan sağa çekilen DÜZ çizgi (kullanıcı isteği: çapraz değil) */}
      <span
        aria-hidden
        className="absolute -left-[1%] top-[52%] h-[0.11em] w-[103%] origin-left rounded-full bg-[#c0564a]"
        style={{
