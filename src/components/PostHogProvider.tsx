...
// Projedar'ın KENDİ PostHog projesi (EU / KVKK). KolayIMAR'la ayrı. Anahtar env'den gelir;
// yoksa public phc_ fallback (client'ta görünür tiptir, gizli değil) → prod'da her hâlde yüklenir.
