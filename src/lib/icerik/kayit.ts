...
export const ICERIKLER: IcerikMeta[] = [
  ...
  },
  {
    ...
    iliskiler: {
      hub: null,
      siblings: ["rehber/musteri-cakismasi-cift-satis", "rehber/eids-emlakci-rehberi", "rehber/tasinmaz-ticareti-yetki-belgesi"],
      tools: [],
      glossary: [],
    },
    ctaLevel: "medium",
  ...
  },
  {
    ...
    iliskiler: {
      hub: null,
      siblings: ["rehber/musteri-cakismasi-cift-satis", "rehber/proje-uzerinden-satis-nasil-yapilir", "rehber/tasinmaz-ticareti-yetki-belgesi"],
      tools: [],
      glossary: [],
    },
    ctaLevel: "medium",
  ...
  {
    slug: "musteri-cakismasi-cift-satis",
    kategori: "rehber",
    contentType: "rehber",
    title: "Çift Satış Nasıl Önlenir? Aynı Dairenin İki Kez Satılması (2026)",
    h1: "Çift Satış Nasıl Önlenir? Müşteri Çakışması, Opsiyon Kilidi ve Canlı Stok",
    description:
      "Çift satış nedir, aynı daire neden iki alıcıya satılır ve opsiyon kilidi bunu nasıl önler? Projeden konut satışında müşteri çakışması, canlı tek kaynak stok ve tahsisle yapısal koruma. Emlak danışmanları ve müteahhitler için rehber.",
    ...
    iliskiler: {
      hub: null,
      siblings: [
        "rehber/musteri-kaydi-ve-hakedis-korumasi",
        "rehber/proje-uzerinden-satis-nasil-yapilir",
        "karsilastirma/ilan-portali-vs-tahsisli-ag",
      ],
      tools: [],
      glossary: ["sozluk/proje-satis-terimleri"],
    },
    ctaLevel: "strong",
    heroGorsel: "/generated/rehber/eids-hero.jpg",
    heroAlt: "Bir gayrimenkul danışmanı, ofiste tablet üzerinde konut projesinin canlı stok ve daire durumunu incelerken",
    canonical: `${SITE}/rehber/musteri-cakismasi-cift-satis`,
    index: true,
    published: true,
  },
  {
  ...
  },
  {
    ...
    iliskiler: {
      hub: null,
      siblings: ["rehber/musteri-cakismasi-cift-satis", "rehber/proje-uzerinden-satis-nasil-yapilir", "sozluk/proje-satis-terimleri"],
      tools: [],
      glossary: [],
    },
    ctaLevel: "medium",
