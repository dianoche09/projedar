...
const GERCEK: Territory[] = [
  ...
  },
  {
    ...
    claims: [{ iddia: "Proje/blok/kat/birim bazında granüler tahsis; emlakçı yalnız tahsisli birimleri görür.", status: "VERIFIED_DB", path: "db/2026-06-17_mahal-listesi.sql + db/2026-07-01_emlakci-kategorizasyon-segment.sql", anchor: "policy mahal_read using emlakci_proje_tahsisli(); tahsis.hedef_filtre jsonb {marka,il,ilce,uzmanlik}", verifiedAt: "2026-08-12" }],
  ...
  },
  {
    ...
    claims: [{ iddia: "Birimi geçici opsiyonla kilitle; süre dolunca otomatik serbest kalır.", status: "VERIFIED_CODE", path: "src/app/api/cron/_lib/isler.ts + src/app/uretici/opsiyonlar/page.tsx:37", anchor: "opsiyonSuresiCalistir cron (süresi dolan opsiyonları temizler) + opsiyon.kilit_bitis", verifiedAt: "2026-08-12" }],
